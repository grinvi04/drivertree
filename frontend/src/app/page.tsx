...
export default function Home() {
  ...
  return (
    <>
      ...
      >
        <div className="max-w-[680px] mx-auto">
          ...
          <div className="flex items-center justify-center gap-3 flex-wrap">
            ...
            <Link href="/calculators" className="btn-ghost">
              계산기 바로가기
            </Link>
          </div>
        </div>
          ...
          <div className="flex flex-wrap items-center gap-x-2 gap-y-1 mt-3 px-1">
            ...
            {POPULAR_SEARCHES.map((term, idx) => (
              <span key={term} className="contents">
                {idx > 0 && (
                  <span className="text-[12px]" style={{ color: 'var(--hairline)' }}>
                    ·
                  </span>
                )}
                <button
          ...
          {isLoading ? (
            <div className="py-24 flex flex-col items-center gap-3">
              <div
                ...
                aria-hidden="true"
              />
              <span className="text-[14px]" style={{ color: 'var(--ink-muted-48)' }}>
                로딩 중...
              </span>
            </div>
          ) : contents.length === 0 ? (
            ...
            >
              <p
                ...
                style={{ color: 'var(--ink)', letterSpacing: '-0.374px' }}
              >
                일치하는 가이드가 없습니다
              </p>
              <p
      ...
      <section className="w-full text-center px-5 py-20 tile-dark">
        <div className="max-w-[580px] mx-auto">
          ...
          >
            TF-IDF 기반 로컬 NLP 엔진이 6개 가이드 DB를
            <br className="hidden sm:inline" />

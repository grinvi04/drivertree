    ...
    <div className="w-full min-h-screen" style={{ background: "var(--canvas-parchment)" }}>
      <div className="max-w-[980px] mx-auto px-5 py-12 w-full">
        ...
        <div className="text-center mb-10">
          ...
          <p style={{ fontSize: "17px", lineHeight: 1.47, letterSpacing: "-0.374px", color: "var(--ink-muted-80)" }}>
        ...
        <div
          ...
          style={{ background: "var(--canvas)", border: "1px solid var(--hairline)", borderRadius: "9999px" }}
        >
          <button
            role="tab"
        ...
        {activeTab === 'penalty' && (
          <div id="panel-penalty" role="tabpanel" className="grid grid-cols-1 md:grid-cols-5 gap-6">
            ...
            {/* 입력 폼 */}
            <div
              className="md:col-span-3 utility-card flex flex-col justify-between"
            >
              <div>
                <h2
                ...
                >
                  <AlertTriangle className="w-5 h-5 shrink-0" style={{ color: "var(--primary)" }} aria-hidden="true" />
                  단속 위반 유형 선택
                </h2>
                ...
                {penaltyLoading ? (
                  ...
                  <div className="space-y-5">
                    ...
                    <div
                      ...
                      style={{ background: "var(--canvas-parchment)", border: "1px solid var(--hairline)" }}
                    >
            ...
            <div className="md:col-span-2 space-y-4">
              {selectedRule ? (
                <>
                  {/* 메인 결과 */}
                  <div
                    className="utility-card relative overflow-hidden text-center"
                  >
                    <div
                    ...
                    >
                      ...
                      <span
                        ...
                        style={{ fontSize: "28px", color: "var(--primary)", letterSpacing: "-0.01em" }}
                      >
                        {(isChildZone
                  ...
                  >
                    ...
                    <p>
                      <strong style={{ color: "var(--ink)" }}>범칙금</strong>: 경찰관에게 직접 적발된
                      경우로, 실제 운전자에게 부과되며 벌점이 합산됩니다.
                    </p>
                  </div>
                </>
              ) : (
          ...
          >
            ...
            <div className="utility-card space-y-5">
              <h2
                ...
                style={{ fontSize: "17px", color: "var(--ink)", letterSpacing: "-0.374px" }}
              >
                <Car className="w-5 h-5 shrink-0" style={{ color: "var(--primary)" }} aria-hidden="true" />
                내 차량 조건 입력
              </h2>
                ...
                <div className="utility-card flex flex-col justify-between h-full">
                  <div>
                    ...
                    >
                      ...
                      <p
                        className="font-semibold"
                        style={{ fontSize: "34px", color: "var(--primary)", letterSpacing: "-0.01em" }}
                      >
                    ...
                    >
                      <TrendingUp className="w-4 h-4" style={{ color: "var(--primary)" }} aria-hidden="true" />
                      지출 항목 세부 비중
                    </h2>
                        ...
                        <div key={label} className="flex flex-col gap-1.5">
                          <div className="flex justify-between items-center text-[13px]">
                            <span
                              ...
                              style={{ color: "var(--ink)" }}
                            >
                              <Icon className="w-3.5 h-3.5 shrink-0" style={{ color: colorHex }} aria-hidden="true" />
                              {label}
                            </span>
                          ...
                          <div
                            ...
                            style={{ background: "var(--canvas-parchment)", borderRadius: "9999px" }}
                            role="progressbar"
                            aria-valuenow={pct}
                            aria-valuemin={0}
                            aria-valuemax={100}
                          ...
                          >
                            <div
                              ...
                              style={{ width: `${pct}%`, background: colorHex, borderRadius: "9999px" }}
                            />
                          </div>
                        </div>
                      ))}
                  ...
                  >
                    본 계산은 연료 시세(휘발유 1,650원/L) 및 차종별 공인 복합 연비를 기반으로
                    추정한 평균 수치입니다.
                  </p>
                </div>
              ) : (
